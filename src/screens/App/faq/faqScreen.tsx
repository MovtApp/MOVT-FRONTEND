  ...
  const faqData = [
    {
      ...
      answer:
        "Treinadores enviam certificações, que são verificadas e as avaliações de usuários ajudam a manter a qualidade.",
    },
    {
      question: "O que fazer se um treinador cancela sessões repetidamente?",
      answer:
        "Você pode reportar o comportamento através do nosso suporte ou solicitar o reembolso da sessão caso o cancelamento ocorra fora das políticas permitidas.",
    },
    {
      question: "Como resolver disputas com treinadores?",
      answer:
        "Nossa equipe de suporte está disponível para mediar qualquer conflito. Basta acessar a aba de atendimento.",
    },
    {
      question: "E se não houver treinadores na minha área?",
      answer:
        "Estamos expandindo rapidamente! Você também pode optar por sessões de treinamento online.",
    },
    {
      question: "Meus dados de localização estão seguros?",
      answer:
        "Sim, utilizamos criptografia de ponta a ponta e seus dados seguem as normas da LGPD.",
    },
    {
