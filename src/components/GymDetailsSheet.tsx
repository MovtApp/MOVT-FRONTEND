...
export const GymDetailsSheet: React.FC<GymDetailsSheetProps> = ({
  ...
  const {
    ...
    error: detailsError,
  } = useGymDetails(gym?.id_academia || null, isOpen);
  ...
  useEffect(() => {
    ...
    const fetchPersonals = async () => {
      ...
      try {
        const res = await api.get(`/personals?limit=100&offset=0&gymId=${gym.id_academia}`);
        ...
        const mapped: PersonalTrainer[] = data.map((t: any) => ({
          ...
          id_academia: t.id_academia || gym.id_academia,
        }));
  ...
  const openWaze = () => {
    ...
    Linking.openURL(url).catch(() => {
      ...
      Linking.openURL(
        `https://www.waze.com/live-map/directions?to=ll.${gym.latitude}%2C${gym.longitude}`
      );
    });
    setShowRouteModal(false);
  };
    ...
    >
      <BottomSheetScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.header}>
          <View style={styles.titleRow}>
            ...
            <View style={styles.ratingBadge}>
              ...
              <Text style={styles.ratingText}>{Number(displayData.rating || 0).toFixed(1)}</Text>
            </View>
          </View>
        ...
        <View style={styles.actionRow}>
          ...
          {(() => {
            const phone =
              displayData.whatsapp || displayData.telefone || gym.whatsapp || gym.telefone;
            const isMobile =
              phone &&
              ...
              <View style={styles.infoItem}>
                ...
                <View style={styles.infoTextContent}>
                  ...
                  <Text style={styles.infoValue}>
                    {displayData.whatsapp || displayData.telefone}
                  </Text>
                </View>
              </View>
            )}
        ...
        <View style={styles.descriptionSection}>
          <Text style={styles.descriptionText}>
            Esta academia faz parte da rede MOVT. Utilize seu token de acesso para realizar o
      ...
      >
        ...
        >
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity style={styles.routeOption} onPress={openGoogleMaps}>
              <View style={[styles.routeIconCircle, { backgroundColor: "#E3F2FD" }]}>
                <Image
                  source={{
                    uri: "https://www.edigitalagency.com.au/wp-content/uploads/Google-Maps-icon-png-medium-size.png",
                  }}
            ...
            {Platform.OS === "ios" && (
              <TouchableOpacity style={styles.routeOption} onPress={openAppleMaps}>
                <View style={[styles.routeIconCircle, { backgroundColor: "#E3F2FD" }]}>
                  <Image
            ...
            <TouchableOpacity style={styles.routeOption} onPress={openWaze}>
              <View style={[styles.routeIconCircle, { backgroundColor: "#E3F2FD" }]}>
                <Image
            ...
            <TouchableOpacity style={styles.cancelButton} onPress={() => setShowRouteModal(false)}>
